...
export interface LocaleMessages {
  ...
  practiceMockInvalidCount: string
  practiceMockCountExceedsAvailable: string
  practiceQuestions: string
  practiceQuestionUnitOnly: string
  ...
  practiceFilterDifficulty: string
  practiceFilterUnmarked: string
  practiceSettingsSummary: string
...
export const zh: LocaleMessages = {
  ...
  configOmitTemperature: "不发送 temperature",
  configReasoningEffort: "思考强度",
  configReasoningDefault: "跟随模型",
  configExtraPrompt: "补充 Prompt",
  ...
  practiceMockInvalidCount: '请输入有效题数',
  practiceMockCountExceedsAvailable: '不能超过可用题数',
  practiceQuestions: '{n} 道题',
  practiceQuestionUnitOnly: '题',
  ...
  practiceFilterDifficulty: '难度',
  practiceFilterUnmarked: '未标注',
  practiceSettingsSummary: '当前筛选匹配 {n} 题',
...
export const zhTW: LocaleMessages = {
  ...
  configAdvancedAIHint: "適用於此裝置上的出題、答題、批改與解析。思考使用 reasoning_effort，支援的檔位取決於模型。OpenAI 推理模型請選擇 max_completion_tokens，並依模型要求勾選不傳送 temperature。",
  ...
  configTemperature: "Temperature (0–2)",
  configOmitTemperature: "不傳送 temperature",
  configReasoningEffort: "思考強度",
  configReasoningDefault: "跟隨模型",
  configExtraPrompt: "補充 Prompt",
  ...
  practiceMockGenerate: '生成试卷',
  practiceMockConfigAdjusted: '筛选条件变化后，部分模拟考试题型数量已调整。',
  practiceMockInvalidCount: '請輸入有效題數',
  practiceMockCountExceedsAvailable: '不能超過可用題數',
  practiceQuestions: '{n} 道題',
  practiceQuestionUnitOnly: '題',
  ...
  practiceFilterDifficulty: '難度',
  practiceFilterUnmarked: '未標註',
  practiceSettingsSummary: '目前篩選符合 {n} 題',
...
export const en: LocaleMessages = {
  ...
  configAdvancedAIHint: "Applies to generation, answers, grading and explanations on this device. Thinking uses reasoning_effort; supported values depend on the model. For OpenAI reasoning models, select max_completion_tokens and omit temperature when required.",
  ...
  configTemperature: "Temperature (0–2)",
  configOmitTemperature: "Do not send temperature",
  ...
  practiceMockInvalidCount: 'Enter a valid question count',
  practiceMockCountExceedsAvailable: 'Cannot exceed available questions',
  practiceQuestions: '{n} Questions',
  practiceQuestionUnitOnly: 'Questions',
  ...
  practiceFilterUnmarked: 'Unmarked',
  practiceSettingsSummary: '{n} questions match the current filters',
...
export const ja: LocaleMessages = {
  ...
  configAdvancedAIHint: "この端末での出題・解答・採点・解説に適用されます。思考は reasoning_effort を使用し、対応値はモデルに依存します。OpenAI の推論モデルでは max_completion_tokens を選び、必要に応じて temperature を送信しないでください。",
  ...
  configTemperature: "Temperature（0～2）",
  configOmitTemperature: "temperature を送信しない",
  ...
  practiceMockInvalidCount: '有効な問題数を入力してください',
  practiceMockCountExceedsAvailable: '利用可能な問題数を超えられません',
  practiceQuestions: '{n} 問',
  practiceQuestionUnitOnly: '問',
  ...
  practiceFilterDifficulty: '難易度',
  practiceFilterUnmarked: '未設定',
  practiceSettingsSummary: '現在の条件に一致する問題: {n} 問',
...
export const ko: LocaleMessages = {
  ...
  configAdvancedAIHint: "이 기기의 출제, 답변, 채점, 해설에 적용됩니다. 사고는 reasoning_effort를 사용하며 지원 범위는 모델에 따라 다릅니다. OpenAI 추론 모델은 max_completion_tokens를 선택하고 필요 시 temperature를 보내지 마세요.",
  ...
  configTemperature: "Temperature (0–2)",
  configOmitTemperature: "temperature 보내지 않음",
  ...
  practiceMockInvalidCount: '유효한 문항 수를 입력하세요',
  practiceMockCountExceedsAvailable: '사용 가능한 문항 수를 초과할 수 없습니다',
  practiceQuestions: '{n} 문제',
  practiceQuestionUnitOnly: '문제',
  ...
  practiceFilterDifficulty: '난이도',
  practiceFilterUnmarked: '미지정',
  practiceSettingsSummary: '현재 필터와 일치하는 문제 {n}개',
...
export const es: LocaleMessages = {
  ...
  configAdvancedAIHint: "Se aplica a la generación, respuestas, corrección y explicaciones en este dispositivo. El pensamiento usa reasoning_effort; los valores admitidos dependen del modelo. En modelos de razonamiento de OpenAI, selecciona max_completion_tokens y omite temperature cuando sea necesario.",
  ...
  configTemperature: "Temperature (0–2)",
  configOmitTemperature: "No enviar temperature",
  ...
  practiceMockInvalidCount: 'Introduce un número válido de preguntas',
  practiceMockCountExceedsAvailable: 'No puede superar las preguntas disponibles',
  practiceQuestions: '{n} preguntas',
  practiceQuestionUnitOnly: 'preguntas',
  ...
  practiceFilterDifficulty: 'Dificultad',
  practiceFilterUnmarked: 'Sin marcar',
  practiceSettingsSummary: '{n} preguntas coinciden con los filtros actuales',
...
export const fr: LocaleMessages = {
  ...
  configAdvancedAIHint: "S'applique à la génération, aux réponses, à la correction et aux explications sur cet appareil. La réflexion utilise reasoning_effort ; les valeurs prises en charge dépendent du modèle. Pour les modèles de raisonnement OpenAI, choisissez max_completion_tokens et omettez temperature si nécessaire.",
  ...
  configTemperature: "Temperature (0–2)",
  configOmitTemperature: "Ne pas envoyer temperature",
  ...
  practiceMockInvalidCount: 'Saisissez un nombre de questions valide',
  practiceMockCountExceedsAvailable: 'Le nombre ne peut pas dépasser les questions disponibles',
  practiceQuestions: '{n} questions',
  practiceQuestionUnitOnly: 'questions',
  ...
  practiceFilterDifficulty: 'Difficulté',
  practiceFilterUnmarked: 'Non marquée',
  practiceSettingsSummary: '{n} questions correspondent aux filtres actuels',
...
export const de: LocaleMessages = {
  ...
  configAdvancedAIHint: "Gilt für Generierung, Antworten, Bewertung und Erklärungen auf diesem Gerät. Denken nutzt reasoning_effort; unterstützte Werte hängen vom Modell ab. Bei OpenAI-Reasoning-Modellen max_completion_tokens wählen und temperature bei Bedarf weglassen.",
  ...
  configTemperature: "Temperature (0–2)",
  configOmitTemperature: "temperature nicht senden",
  ...
  practiceMockInvalidCount: 'Geben Sie eine gültige Anzahl ein',
  practiceMockCountExceedsAvailable: 'Die Anzahl darf die verfügbaren Fragen nicht überschreiten',
  practiceQuestions: '{n} Fragen',
  practiceQuestionUnitOnly: 'Fragen',
  ...
  practiceFilterUnmarked: 'Nicht markiert',
  practiceSettingsSummary: '{n} Fragen passen zu den aktuellen Filtern',
...
export const ru: LocaleMessages = {
  ...
  configAdvancedAIHint: "Применяется к генерации, ответам, проверке и пояснениям на этом устройстве. Рассуждение использует reasoning_effort; поддерживаемые значения зависят от модели. Для моделей рассуждения OpenAI выберите max_completion_tokens и при необходимости не отправляйте temperature.",
  ...
  configTemperature: "Temperature (0–2)",
  configOmitTemperature: "Не отправлять temperature",
  ...
  practiceMockInvalidCount: 'Введите допустимое количество вопросов',
  practiceMockCountExceedsAvailable: 'Нельзя превысить доступное количество вопросов',
  practiceQuestions: '{n} вопросов',
  practiceQuestionUnitOnly: 'вопросов',
  ...
  practiceFilterUnmarked: 'Без отметки',
  practiceSettingsSummary: 'Подходит вопросов по текущим фильтрам: {n}',
...
export const ar: LocaleMessages = {
  ...
  configAdvancedAIHint: "يُطبَّق على التوليد والإجابات والتصحيح والشرح على هذا الجهاز. يستخدم التفكير reasoning_effort وتعتمد القيم المدعومة على الطراز. في طرازات الاستدلال من OpenAI اختر max_completion_tokens واحذف temperature عند الحاجة.",
  ...
  configTemperature: "Temperature (0–2)",
  configOmitTemperature: "عدم إرسال temperature",
  ...
  practiceMockInvalidCount: 'أدخل عددًا صالحًا من الأسئلة',
  practiceMockCountExceedsAvailable: 'لا يمكن تجاوز عدد الأسئلة المتاحة',
  practiceQuestions: '{n} سؤالاً',
  practiceQuestionUnitOnly: 'أسئلة',
  ...
  practiceFilterUnmarked: 'غير محدد',
  practiceSettingsSummary: 'عدد الأسئلة المطابقة للفلاتر الحالية: {n}',
